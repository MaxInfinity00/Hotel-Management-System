...
if(isset($login))
{
	...
	{
	$sql=mysqli_query($con,"select * from loginmst where user_id='$userid' && hashed_password='$pass' && Account_type='FDM' ");
...
include('Menu Bar.php');
	?>
<div style="margin:100px;" class="container-fluid"> <!-- Primary Id-->
  <div class="container">
    <div class="row"><br>
