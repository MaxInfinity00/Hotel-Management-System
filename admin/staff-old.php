...
<?php } ?>
	...
	<tr>
	<td colspan="7"><a href="dashboard.php?option=add_staff" class="btn btn-success">Add Staff</a></td>
	</tr>
	<tr style="height:40">
		<th>Staff Id</th>
...
?>
		...
		<tr>
			...
			<td><?php echo date('F j, Y',strtotime($res['DOB'])); ?></td>
...
<?php } ?>
<td><a class="btn btn-info white-text-btn" href="dashboard.php?option=view_attendance&id=<?php echo $res['Staff_id']; ?>">View Attendance</a></td>
							</tr>
		<tr>
