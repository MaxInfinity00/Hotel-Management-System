...
<?php } ?>
	...
	<td colspan="8">
		<div class="row">
			<div class="col-sm-6">
				<a href="dashboard.php?option=add_rooms" class="btn btn-success">Add New Rooms</a>
			</div>
			<div class="col-sm-6">
				<a href="dashboard.php?option=room_types" class="btn btn-warning white-text-btn">Room Types</a>
			</div>
		</div>
		</td>
	</tr>
