...
<?php } ?>
	...
	<tr>
		<td colspan="11"><a href="../Registation form.php" class="btn btn-success">Add Customer</a></td>
	</tr>
	<tr>
		<th>Sr No</th>
		<th>Name</th>
...
<tr>
		...
		<td><a class="btn btn-primary" href="../update_profile.php">Update Customer</a></td>
<?php if ($active){ ?>
